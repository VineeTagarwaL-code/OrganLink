  ...
  return (
    <div className="flex">
      ...
      <div className="flex flex-col w-screen bg-white ">
        <div className="p-4 w-full flex justify-center items-center  bg-red-400 space-x-2">
          Enquiries
        </div>
        <div className="flex h-full p-3">
          {users &&
            users.map((user: any) => (
              <div
                className="w-1/6  h-1/6 rounded-xl flex   bg-blue-400/50 items-center justify-center text-xl p-4 m-2 text-black bg-blue-500 cursor-pointer"
                onClick={() =>
                  navigate({
                    pathname: `/chat/${id}`,
                    search:
