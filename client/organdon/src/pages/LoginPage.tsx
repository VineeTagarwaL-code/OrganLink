    ...
    <div className="w-screen h-screen  bg-background flex  items-center justify-center md:overflow-y-hidden overflow-y-scroll">
      ...
      <div className="flex items-center justify-evenly w-[55%]  ">
        <div className="hidden lg:block">
          ...
          >
            <path
              id="b10fb2cf-c586-4c5f-9fbf-e678f5ffa3db-70"
              data-name="Path 133"
            ...
            />
            <path
              id="a32c10c7-75df-4179-a648-6a8d2a687209-71"
              data-name="Path 134"
            ...
            <path
              ...
              fill="#ed5757"
            />
            <circle cx="131.82814" cy="239.22404" r="51" fill="#ed5757" />
            <path
        ...
        <div className=" h-[100%] flex justify-center items-center gap-6 ">
          <div>
            ...
            <div>
              <p className="text-[#B9C0C7] flex justify-center pt-4">
                Don't have an account ? <span> </span>
                <span
                  onClick={() => navigate("/signup")}
                  className="text-[#ed5757] cursor-pointer ml-2"
                >
                  Signup here
                </span>
              </p>
