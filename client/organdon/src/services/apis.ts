...
export const userEndpoints = {
    ...
    GET_INSTITUTE_ORGANS: import.meta.env.VITE_BASE_URL + "/api/v1/organs/hospital",
    ...
    UPLOAD_CERTIFICATE_API: import.meta.env.VITE_BASE_URL + "/api/v1/files/upload",
    ...
    GET_MESSAGES_FOR_HOSPITAL: import.meta.env.VITE_BASE_URL +"/api/v1/messages/users",
